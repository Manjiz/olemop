...
var transactionLogger = require('@olemop/logger').getLogger('transaction-log', __filename);
var transactionErrorLogger = require('@olemop/logger').getLogger('transaction-error-log', __filename);
